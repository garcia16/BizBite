...
import '../../../logic/reports/buildSalesReports.dart';
...
class AddSalesReportView extends StatefulWidget {

  @override
  _AddSalesReportViewState createState() => _AddSalesReportViewState();
}

class _AddSalesReportViewState extends State<AddSalesReportView> {
  bool includeAllYear = false;
  bool includeSalesBreakdown = false;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBarToBack(context, 'Nuevo informe de ventas'),
  ...
  ElevatedButton buttonGenerateReport(BuildContext context) {
    return ElevatedButton(
      onPressed: () async {
        await generatePdfSales(includeAllYear, includeSalesBreakdown, uploadToCloud, dropdownValue, dropdownValueYear);
  ...
  CheckboxListTile selectFullSales() {
    return CheckboxListTile(
      title: const Text('Incluir desglose ventas'),
      value: includeSalesBreakdown,
      onChanged: (bool? value) {
        setState(() {
          includeSalesBreakdown = value!;
        });
      },
    );
  }
